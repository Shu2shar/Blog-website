<x-app-layout>
    <x-slot name="header">
        <div class="flex justify-between items-center">
            ...
            <a href="{{ route('user.index') }}" class="bg-slate-700 text-md rounded-md px-4 py-2 text-white">Back</a>
        </div>
    </x-slot>
                ...
                <div class="p-6 text-gray-900">
                    ...
                    <form action="{{ route('user.store') }}" method="POST">
                        ...
                        <div class="">
                            ...
                            <button class="bg-slate-700 text-md rounded-md px-4 py-3 text-white">Submit</button>
                        </div>
                    </form>
                </div>
            </div>
