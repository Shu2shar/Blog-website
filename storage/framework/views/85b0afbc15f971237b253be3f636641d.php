...
<?php $component->withAttributes([]); ?>
     <?php $__env->slot('header', null, []); ?> 
        <div class="flex justify-between">
            ...
            <?php if (app(\Illuminate\Contracts\Auth\Access\Gate::class)->check('create tag')): ?>
                <a href="<?php echo e(route('tags.create')); ?>" class="bg-blue-600 text-white px-4 py-2 rounded hover:bg-blue-700">Create
                    Post</a>
            <?php endif; ?>
        </div>
     <?php $__env->endSlot(); ?>
...
<?php endif; ?>
                    ...
                    <?php $__currentLoopData = $tags; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $tag): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                        <div class="bg-white p-4 rounded shadow mb-3 flex justify-between items-center">
                            <div><?php echo e($tag->name); ?></div>
                            <div class="flex gap-3">
                                <?php if (app(\Illuminate\Contracts\Auth\Access\Gate::class)->check('update tag')): ?>
                                    <a href="<?php echo e(route('tags.edit', $tag)); ?>" class="text-blue-600">Edit</a>
                                <?php endif; ?>
...
<?php endif; ?>
<?php /**PATH C:\laragon\www\Blog-website\resources\views/tags/index.blade.php ENDPATH**/ ?>